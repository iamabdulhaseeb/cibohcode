...
//   merchantId:'merchant.com.sah-tech.ciboh-ios'
// });
...
//     const options = {
//       requiredBillingAddressFields: false,
//       requiredShippingAddressFields: false,
//       shippingMethods,
//     }
...
import { StyleSheet, Text, View, LogBox, Platform,StatusBar,Alert,TouchableOpacity } from 'react-native';
...
function ConfigureMyGoogle() {
  GoogleSignin.configure({
    webClientId:
      '1068487314849-t66ua0igad7ho9uld9339kvf4t6oq8o1.apps.googleusercontent.com',
...
export default function App() {
  ...
  return (
    ...
    //   <Text style={{fontSize:20,fontFamily:'Zermatt-First'}}>Hello, this is the zermat font.</Text>
    // </View>
