...
export default function HomeSlider({recipe}) {
          ...
          <View >
              ...
              >
                ...
                <View style={styles.likes} >
                  ...
                  <Text style={[styles.subheadingTwo, {fontFamily: 'Roboto'}]}>{item.likes.length}</Text>
                </View>

                <View style={styles.imgContent} >
                  <Text style={[styles.headingOne, {fontFamily: 'AvianoFlareRegular',}]}>{item.title}</Text>
                  <Text style={[styles.headingTwo, {fontFamily: 'sofiaprolight',}]}>by {item.createdBy.name}</Text>
                </View>
                <View style={styles.imgSub} >
                  <MaterialCommunityIcons name='history' size={15} color="white" />
                  <Text style={[styles.subheadingOne, {fontFamily: 'Roboto',}]}>{item.BakingTime} mint</Text>
    ...
    return (
      <View style={styles.screen}>
          <Text style={[styles.sliderHeading, {fontFamily: 'Zermatt-First'}]} >
              Recommended for you.
          </Text>
          ...
          <View style={styles.dotsPgae} >
            <Pagination
              dotsLength={recipe == null || recipe.length === 0 ? 0 : recipe.length}
